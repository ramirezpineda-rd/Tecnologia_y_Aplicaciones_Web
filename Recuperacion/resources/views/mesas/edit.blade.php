...
@section('content')
    ...
    <div class="col-md-8 mx-auto bg-danger text-white p-3">
        <h2 class="text-left mb-7">Editar mesa</h2>
    </div>
    <!-- Diseñar el formulario para guardar receta -->
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
        <form method="POST" action="{{route('mesas.update', compact('mesa'))}}"><!--Validacion -->
        @method('PUT')
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror"
                placeholder="Nombre del mesero" value={{$mesa->nombre}}>
