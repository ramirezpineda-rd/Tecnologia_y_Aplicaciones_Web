<?php
    class MvcControllerCarrera {
        ...
        public function registroCarreraController(){
            ...
            $respuesta = Datos1::registroCarreraModel($datosController, "carreras");
        ...
        public function vistaCarreraController(){
            ...
            $respuesta = Datos1::vistaCarreraModel("carreras");
        ...
        public function editarCarreraController(){
            ...
            $respuesta = Datos1::editarCarreraModel($datosController, "carreras");
        ...
        public function actualizarCarreraController(){
            if(isset($_POST["carreraEditar"])){
                ...
                $respuesta = Datos1::actualizarCarreraModel($datosController,"carreras");
        ...
        public function borrarCarreraController(){
            ...
            $respuesta = Datos1::borrarCarreraModel($datosController, "carreras");
