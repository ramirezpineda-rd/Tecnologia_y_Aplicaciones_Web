@extends('layouts.app')
<!--Va  a mostrar la información de perfíl-->
            ...
            @if( count($recetas) > 0)
                @foreach($recetas as $receta)
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <img src="/storage/{{$receta->imagen}}" class="card-img-top" alt="imagen receta"><!--Texto alternativo-->
                            ...
                            <div class="card-body">
                                ...
                                <!--Con el id de la ruta para poder ver la receta-->
                            </div>
                        </div>
                    </div>
                @endforeach
